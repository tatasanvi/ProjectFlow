...
<div class="my-3 p-6 bg-body rounded shadow-sm">
  <h3 class="border-bottom pb-2 mb-3">Création d'un nouvelle contrainte</h3>
  <div class="mt-4">
    ...
    <form style="width:65%;" method="post" action="{{route('contraintes.ajouter')}}">
      @csrf
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" required name="statut">
  </div>
  <div class="mb-3">
