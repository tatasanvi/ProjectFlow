...
<div class="my-3 p-6 bg-body rounded shadow-sm">
  <h3 class="border-bottom pb-2 mb-3">Création d'un nouveau projet</h3>
  <div class="mt-4">
    ...
    <form style="width:65%;" method="post" action="{{route('projets.ajouter')}}">
      @csrf
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" required name="nomProjet">
  </div>
  <div class="mb-3">
